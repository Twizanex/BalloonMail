...
//Con esto ponemos el texto del link
   a.innerHTML = '<?php echo ballom_echo("deleteAttachFile"); ?>';
...
<div id="papiro">
	 <form class="form" method="post" name="mensajeForm" action="contenidoIndex.php?menuOption=soltarGlobo" enctype="multipart/form-data" >
          ...
          <table width="670" height="356" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="266" valign="top" style="background-image:url(imagenes/papiro/papiro_03enviar.jpg); background-position:center">
			  <table width="100%" border="0" cellpadding="0" cellspacing="2">
                <tr>
                  <td colspan="2"><h1>
                  <?php if ($tipoMsj==1) //Respuesta
                  			$labelAnswer= $tituloMail;
                  		else
                  		if ($tipoMsj==3) //Reporte de Abuso
                  			$labelAnswer= ballom_echo("titleReporteAbuse");
                  		else
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="2">
                  <tr>
                    <td width="200%" height="190" colspan="4" valign="top"><textarea label name="mensaje" style="width:98%; height:90%; background-color:transparent; overflow-x:hidden; overflow-y:auto; border: solid thin #999999;" onfocus="if(this.value == '<?php  echo ballom_echo("typeTheMessagesIntoBallon");?>') this.value=''" onblur="if(this.value == '') this.value='<?php  echo ballom_echo("typeTheMessagesIntoBallon");?>'"/><?php  echo ballom_echo("typeTheMessagesIntoBallon");?></textarea></td>
                  </tr>
                  </table>
              </div>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="30%" rowspan="2" valign="middle" class="anotacion">
                    <?php if ($tipoMsj!=3) { ?>
                    <p>
                    ...
                    <?php  if ($tipoMsj==1) //Respuesta
                           		$buttonName= ballom_echo("answerBalloon");
                           else
                           		if ($tipoMsj==3) //Reporte de Abuso
                           			$buttonName= ballom_echo("reportAbuse");
                    			else //Globo Normal
                  ...
                  ?>
                   ...
                   <?php if ($tipoMsj==4 || $tipoMsj==1)  {
                    echo "<td width='21%' align='center' >";
                   }
                   else
                   {
                   	echo "<td width='21%' align='center' rowspan='2' >";
                   }
                   ?>
                   <select name="selectIdioma" class="bajo_soltar" id="select" style="border:none; width:60px; background-color:transparent">
					<?php
                  ...
                  <tr>
                      <td align="center" valign="middle" colspan="2"><div id="adjuntos"></div><label><?php if ($tipoMsj!=3 ){?><a href="#" onClick="addCampo()"><?php echo ballom_echo("attachFile"); ?></a><?php }?></label>
                      </td>
                  </tr>
              </table>
			  </td>
...
if (($tipoMsj==1) ||  ($tipoMsj==3))
{
	echo "<input name='idTipoMensaje' type='hidden' value='".$tipoMsj."'>";
	echo "<input name='idMensaje' type='hidden' value='".$_GET['idMensaje']."'>";
}
elseif ($tipoMsj==4)
    echo "<input name='idTipoMensaje' type='hidden' value='4'>";
?>
