...
<?php	echo $message; ?>
        <table width="320" border="0" cellpadding="3" cellspacing="5">
          <tr>
            <td width="49%" align="right"><?php  echo ballom_echo("name");?></td>
          ...
          <tr>
            ...
            <td align="center" class="txt_login"><input name="email" type="text" class=":required :email" size="22" style="border:none" /></td>
          </tr>
          <tr>
            <td align="right"><?php  echo ballom_echo("password");?></td>
            <td align="center" class="txt_login">
				<input name="contrasenia" id="contrasenia" type="password"
					class=":required :min_length;6 :format;/\d.*?\d/;contrasenia_format"
					size="22" style="border:none" />
				<div id="contrasenia_format" style="display:none"><?php  echo ballom_echo("contrasenia_format");?></div>
			</td>
          </tr>
          <tr>
            <td align="right"><?php  echo ballom_echo("checkPassword");?></td>
            <td align="center" class="txt_login">
            ...
            <td align="center" class="txt_login"><table width="90%" border="0" align="center" cellpadding="2" cellspacing="1">
              <tr>
                <td align="left"><select name="diaNac" id="diaNac">
                  <option selected="selected" style="border:none">01</option>
                  <option>02</option>
                  <option>03</option>
                  <option>04</option>
                  <option>05</option>
          ...
          <tr>
            <td align="right"><?php  echo ballom_echo("sex");?></td>
            <td align="center" class="txt_login"><select name="sexo" id="sexo"  style="border:none; width:160px">
              <option value="M"><?php  echo ballom_echo("male");?></option>
              <option value="F"><?php  echo ballom_echo("female");?></option>
            </select></td>
          </tr>
          <tr>
            <td align="right"><?php  echo ballom_echo("interestAirstream");?></td>
            <td align="center">
  ...
  <?php
	...
	<?php }?>
        ...
        <tr>
            <td valign="middle">&nbsp;</td>
            <td valign="middle"><input name="button" type="submit" class="txt_login" id="button" value="<?php  echo ballom_echo("register");?>" /></td>
          </tr>
          <tr>
            <td colspan="2" align="right" valign="middle"><input type="checkbox" name="checkbox2" id="checkbox2" checked="checked" />
            <a href="#"><?php  echo ballom_echo("termsOfUse");?></a></td>
          </tr>
        </table>
      </div>
